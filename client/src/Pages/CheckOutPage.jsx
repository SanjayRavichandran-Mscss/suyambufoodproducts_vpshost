...
const CheckOutPage = () => {
  ...
  const fetchCart = async () => {
    ...
    try {
      const token = localStorage.getItem("customerToken");
      const response = await fetch(`https://suyambufoods.com/customer/cart?customerId=${customerId}`, {
        headers: {
          "Content-Type": "application/json",
          Origin: "http://localhost:5173",
          Authorization: `Bearer ${token}`,
  ...
  const updateQuantity = async (variantId, change) => {
    ...
    try {
      const token = localStorage.getItem("customerToken");
      const response = await fetch(`https://suyambufoods.com/customer/cart`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
          Origin: "http://localhost:5173",
  ...
  const handlePlaceOrder = async () => {
    ...
    if (selectedPaymentMethodId === 1) {
      try {
        const response = await fetch(`https://suyambufoods.com/customer/orders`, {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
      ...
      try {
        const createOrderResponse = await fetch(`https://suyambufoods.com/customer/payment/create-order`, {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
        ...
        const options = {
          ...
          handler: async function (response) {
            const verifyResponse = await fetch(`https://suyambufoods.com/customer/payment/verify`, {
                method: "POST",
                headers: {
                  "Content-Type": "application/json",
                  Authorization: `Bearer ${token}`,
            ...
            if (verification.success) {
                ...
                const placeOrderResponse = await fetch(`https://suyambufoods.com/customer/orders`, {
                    method: "POST",
                    headers: {
                        "Content-Type": "application/json",
                        Authorization: `Bearer ${token}`,
