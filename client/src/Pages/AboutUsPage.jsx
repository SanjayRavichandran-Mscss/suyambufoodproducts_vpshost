...
//   // Expose global login/register functions (same as CustomerPage)
//   useEffect(() => {
...
//                 </ul>
//               </div>
//               {/* ... rest of privacy policy sections remain unchanged ... */}
//               <p className="font-medium text-gray-900">
            ...
            <div className="bg-white rounded-xl p-6 md:p-8 shadow-sm border border-gray-200 text-gray-600 space-y-6 leading-relaxed">
              ...
              <div>
                ...
                <ul className="list-disc list-inside mt-2 space-y-1">
                  ...
                  <li>Supporting images or videos showing the product issue must be shared via email at suyambufoodcare@gmail.com.</li>
                </ul>
              </div>
              <div>
