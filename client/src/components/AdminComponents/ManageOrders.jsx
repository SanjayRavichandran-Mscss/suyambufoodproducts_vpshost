...
const ManageOrders = () => {
  ...
  useEffect(() => {
    const fetchOrders = async () => {
      try {
        const response = await fetch("https://suyambufoods.com/api/api/admin/orders");
        if (!response.ok) {
  ...
  const handleSave = async (orderId) => {
    ...
    try {
      const response = await fetch(`https://suyambufoods.com/api/api/admin/orders/${orderId}/status`, {
        method: 'PUT',
