...
export default function Banner({ customerId }) {
      ...
      <section className="bg-white py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-[#3D2F23] mb-4">Why Suyambu?</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              At Suyambu, we believe in the power of nature. Our products are a celebration of purity, tradition, and the finest organic ingredients.
            </p>
          </div>
  ...
  {cat.label}
  <span className="font-bold text-lg opacity-90">({count})</span>
</span>
                </button>
              );
            })}
